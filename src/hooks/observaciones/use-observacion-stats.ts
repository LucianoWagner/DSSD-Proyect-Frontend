 ...
 */
export function useObservacionStats() {
  // Fetch all observations (no filters)
  const { data: allData, isLoading: isLoadingAll } = useListObservaciones({ page_size: 1 });
